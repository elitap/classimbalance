...
try:
    ...
    from scripts.eval.surface_distance import metrics as sd
except ImportError:
    import defs
    import surface_distance.metrics as sd


OUTPUT_FILE_KEY = ".nii.gz"
RESULT_SUB_DIR = "out"
ID_IDX = 9
ID_IDX_TCIA = 11
...
def write_header():
    header = "Model,Checkpoint,File,Organ,dice,95haus_dist,surface_dice"
    print(header)
    return header
...
def evaluate(gt_base_path, result_base_path, result_file, model,
             special_checkpoint, result_dir, threads,
...
if __name__ == "__main__":
    ...
    evaluate(gtdir, modeldir, resfile, args.model, args.checkpoint, RESULT_SUB_DIR, args.threads,
