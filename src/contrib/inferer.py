...
class SlidingWindowInferer2(SlidingWindowInferer):
    """
    ...
    def __init__(
        ...
        SlidingWindowInferer.__init__(self,
                                      roi_size=roi_size,
